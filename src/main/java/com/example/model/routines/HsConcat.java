...
public class HsConcat extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -159480451;

	/**
	 * The parameter <code>public.hs_concat.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.hs_concat._1</code>.
	 */
	...
	/**
	 * The parameter <code>public.hs_concat._2</code>.
	 */
	 ...
	 */
	public HsConcat() {
		super("hs_concat", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("USER-DEFINED"));

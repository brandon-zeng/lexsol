...
public class GinExtractHstore extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -944037987;

	/**
	 * The parameter <code>public.gin_extract_hstore.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.gin_extract_hstore._1</code>.
	 */
	...
	/**
	 * The parameter <code>public.gin_extract_hstore._2</code>.
	 */
	...
	public GinExtractHstore() {
		super("gin_extract_hstore", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));

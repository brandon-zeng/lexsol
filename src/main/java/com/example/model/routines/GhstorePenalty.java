...
public class GhstorePenalty extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1233767814;

	/**
	 * The parameter <code>public.ghstore_penalty.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.ghstore_penalty._1</code>.
	 */
	...
	/**
	 * The parameter <code>public.ghstore_penalty._2</code>.
	 */
	...
	/**
	 * The parameter <code>public.ghstore_penalty._3</code>.
	 */
	...
	public GhstorePenalty() {
		super("ghstore_penalty", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));

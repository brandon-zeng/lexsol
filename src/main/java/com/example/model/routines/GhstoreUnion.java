...
public class GhstoreUnion extends AbstractRoutine<Object> {
	...
	private static final long serialVersionUID = -1660952275;

	/**
	 * The parameter <code>public.ghstore_union.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.ghstore_union._1</code>.
	 */
	...
	/**
	 * The parameter <code>public.ghstore_union._2</code>.
	 */
	 ...
	 */
	public GhstoreUnion() {
		super("ghstore_union", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));

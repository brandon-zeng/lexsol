...
public class NotetypeRecord extends UpdatableRecordImpl<NotetypeRecord> implements Record8<Integer, String, Integer, Boolean, Integer, Boolean, Integer, String> {

	private static final long serialVersionUID = -162914497;
	 ...
	 */
	public void setDiscussiontopics(String value) {
		setValue(7, value);
	}
	 ...
	 */
	@Override
	public Row8<Integer, String, Integer, Boolean, Integer, Boolean, Integer, String> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<Integer, String, Integer, Boolean, Integer, Boolean, Integer, String> valuesRow() {
	 ...
	 */
	@Override
	public NotetypeRecord value8(String value) {
	 ...
	 */
	@Override
	public NotetypeRecord values(Integer value1, String value2, Integer value3, Boolean value4, Integer value5, Boolean value6, Integer value7, String value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public NotetypeRecord(Integer id, String name, Integer tenantId, Boolean secondarydate, Integer sitevisitId, Boolean showdealissues, Integer deletepermittedinterval, String discussiontopics) {
		super(Notetype.NOTETYPE);
